...
export const getUploadFileMutationOptions = <TError = unknown,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof uploadFile>>, TError,{petId: number;data: UploadFileBody}, TContext>, }
...
export const getAddPetMutationOptions = <TError = void,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof addPet>>, TError,{data: PetBody}, TContext>, }
...
export const getUpdatePetMutationOptions = <TError = void | void | void,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof updatePet>>, TError,{data: PetBody}, TContext>, }
...
const {mutation: mutationOptions} = options ?
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type UpdatePetMutationError = void | void | void

    /**
 * @summary Update an existing pet
 */
export const useUpdatePet = <TError = void | void | void,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof updatePet>>, TError,{data: PetBody}, TContext>, }
 , queryClient?: QueryClient): UseMutationResult<
...
export const getGetPetByIdQueryOptions = <TData = Awaited<ReturnType<typeof getPetById>>, TError = void | void>(petId: number, options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof getPetById>>, TError, TData>>, }
) => {
...
export type GetPetByIdQueryError = void | void


export function useGetPetById<TData = Awaited<ReturnType<typeof getPetById>>, TError = void | void>(
...
export const getUpdatePetWithFormMutationOptions = <TError = void,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof updatePetWithForm>>, TError,{petId: number;data: UpdatePetWithFormBody}, TContext>, }
...
export const getDeletePetMutationOptions = <TError = void | void,
...
const {mutation: mutationOptions} = options ?
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type DeletePetMutationError = void | void

    /**
 * @summary Deletes a pet
 */
export const useDeletePet = <TError = void | void,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof deletePet>>, TError,{petId: number}, TContext>, }
 , queryClient?: QueryClient): UseMutationResult<
...
export const getGetInventoryQueryOptions = <TData = Awaited<ReturnType<typeof getInventory>>, TError = unknown>( options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof getInventory>>, TError, TData>>, }
) => {
...
export const getGetOrderByIdQueryOptions = <TData = Awaited<ReturnType<typeof getOrderById>>, TError = void | void>(orderId: number, options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof getOrderById>>, TError, TData>>, }
) => {
...
export type GetOrderByIdQueryError = void | void


export function useGetOrderById<TData = Awaited<ReturnType<typeof getOrderById>>, TError = void | void>(
...
export const getDeleteOrderMutationOptions = <TError = void | void,
...
const {mutation: mutationOptions} = options ?
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type DeleteOrderMutationError = void | void

    /**
 * @summary Delete purchase order by ID
 */
export const useDeleteOrder = <TError = void | void,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof deleteOrder>>, TError,{orderId: number}, TContext>, }
 , queryClient?: QueryClient): UseMutationResult<
...
export const getCreateUsersWithListInputMutationOptions = <TError = void,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof createUsersWithListInput>>, TError,{data: UserArrayBody}, TContext>, }
...
export const getGetUserByNameQueryOptions = <TData = Awaited<ReturnType<typeof getUserByName>>, TError = void | void>(username: string, options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof getUserByName>>, TError, TData>>, }
) => {
...
export type GetUserByNameQueryError = void | void


export function useGetUserByName<TData = Awaited<ReturnType<typeof getUserByName>>, TError = void | void>(
...
export const getCreateUsersWithArrayInputMutationOptions = <TError = void,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof createUsersWithArrayInput>>, TError,{data: UserArrayBody}, TContext>, }
